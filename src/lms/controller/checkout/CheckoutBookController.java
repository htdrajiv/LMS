...
import lms.common.ConfigurationConstants;
...
public class CheckoutBookController implements Initializable {
	...
	public void btnCheckoutClick() {
		...
		membersHashMap = dataAccess.readMemberMap();
		...
		booksHashMap = dataAccess.readBooksMap();
		...
		dataAccess.saveNewMember(existingLibraryMember);
		dataAccess.saveNewBook(existingBook);
